...
if __name__ == '__main__':
    ...
    for m in models:
        ...
        os.system(cmd)
#        cmd = "docker tag ucvm_257_%s_remote:%s sceccode/ucvm_257_%s_remote:%s"%(m,mdate,m,mdate)
#        os.system(cmd)

#    for m in models:
#        print("pushing models: " + m + " with sceccode/ucvm_257_%s_remote:%s" % (m,mdate))
#        cmd = "docker push sceccode/ucvm_257_%s_remote:%s" % (m,mdate)
#        cmd = "docker push sceccode/ucvm_257_%s_remote:latest" % (m)
#        os.system(cmd)
